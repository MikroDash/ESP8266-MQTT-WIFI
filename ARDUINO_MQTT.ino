...
//Topics MQTT
const char* topic_sensor = "160856dec6a7f3f9a31ff73a6/sensor";
const char* topic_button = "160856dec6a7f3f9a31ff73a6/button";
const char* topic_pwm = "160856dec6a7f3f9a31ff73a6/pwm";
const char* topic_led = "160856dec6a7f3f9a31ff73a6/led";

// Constantes de configuracion
const char* ssid = "WIFI-MIKRODASH";              //Nombre Red Wi-Fi
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (JSON.typeof(myObject) == "undefined") { // Si el archivo no tiene información o no es JSON se sale del callback
    ...
    Serial.println(strcmp(from,"app"));
...
void loop() {
  ...
  delay(45); //Un delay de 50ms para darle un respiro al modulo de wifi ESP8266
}
